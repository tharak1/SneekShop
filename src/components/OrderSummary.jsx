...
const Ordersum5 = () => {
    ...
    const storedOrderInfoString = localStorage.getItem('orderInfo');

        // Parse the orderInfo string back into an object
        const storedOrderInfo = JSON.parse(storedOrderInfoString);
                    ...
                    <div className="flex justify-center items-center w-full mt-8  flex-col space-y-4 ">
                        <div className="flex md:flex-row justify-start items-start md:items-center  border border-gray-200 w-full">
                            <div className="w-40 md:w-32">
                                <img className="hidden md:block" src={storedOrderInfo.cartItems[0].title.imageUrl} />
                                <img className="md:hidden " src={storedOrderInfo.cartItems[0].title.imageUrl} alt="girl-in-red-dress" />
                            </div>
                            <div className="flex justify-start md:justify-between items-start md:items-center  flex-col md:flex-row w-full p-4 md:px-8">
                                <div className="flex flex-col md:flex-shrink-0  justify-start items-start">
                                    <h3 className="text-lg md:text-xl  w-full font-semibold leading-6 md:leading-5  text-gray-800">{storedOrderInfo.cartItems[0].title}</h3>
                                ...
                                <div className="flex mt-4 md:mt-0 md:justify-end items-center w-full ">
                                    <p className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-gray-800">{storedOrderInfo.cartItems[0].price}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col justify-start items-start mt-8 xl:mt-10 space-y-10 w-full">
                        <div className="flex justify-start items-start flex-col md:flex-row  w-full md:w-auto space-y-8 md:space-y-0 md:space-x-14 xl:space-x-8  lg:w-full">
                            <div className="flex jusitfy-start items-start flex-col space-y-2">
                                ...
                                <p className="text-sm leading-5 text-gray-600">{storedOrderInfo.addressInfo.address}</p>
                            </div>
                            <div className="flex jusitfy-start items-start flex-col space-y-2">
                        ...
                        <div className="flex flex-col space-y-4 w-full">
                            ...
                            <div className="flex justify-between items-center w-full">
                                ...
                                <p className="text-base font-semibold leading-4 text-gray-600">549</p>
                            </div>
                            <div className="flex flex-col w-full justify-center items-center pt-1 md:pt-4  xl:pt-8 space-y-6 md:space-y-8 flex-col">
                                ...
                                <button className="py-5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800  w-full text-base font-medium leading-4 text-white bg-gray-800 hover:bg-black" onClick={Tohome}>Take Me Home</button>
